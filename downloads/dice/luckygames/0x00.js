...
$('.betContainer').html('<center><div class="inputBox">' +
    ...
    '<button class="btn gray" id="viewStatic" onclick="viewStatic();">View Static</button> ' +
    '</center> ' +
...
$.getScript('//canvasjs.com/assets/script/canvasjs.min.js')
    .done(function (script, textStatus) {
        ...
        chart = new CanvasJS.Chart('chart', {
            ...
            title: { text: 'LuckyGames Bot ID 0x00 - lequanglam.github.io', fontSize: 16 },
