...
// SIG: 82f98371ecf633a6c0717768a4392ad55754ad9f
// TIM: 1539674787

var SCRIPTID = window.atob("MHgwNg==");
var TIME = 1539674787;
var TIMES = new Date(TIME * 1000);
var SIG = "82f98371ecf633a6c0717768a4392ad55754ad9f".toUpperCase();
			...
			jQuery.ajax({
				...
				success: function (data) {
					...
					if (data.result === true) {
						...
						$('#notification').html('D/P = ' + direction + ' ' + prediction);
						(randomInt(0,1) == 0) ? direction = "under" : direction = "over";
						prediction = randomInt(1, 98);
						bet++;
						...
						balancelose += parseFloat(data.profit);
						...
						if (Math.abs(balancelose) < basebetAmount) { 
							betAmount = basebetAmount;
						} else if (balancelose > -0.00000001) {
							balancelose = 0;
							betAmount = basebetAmount;
						} else {
							betAmount = Math.abs(balancelose);
						}
